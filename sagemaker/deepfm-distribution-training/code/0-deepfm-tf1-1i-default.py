...
#2 Train pipline using Custom Estimator by rewriting model_fn
...
### @guoren
tf.app.flags.DEFINE_string("data_dir", os.environ['SM_INPUT_DIR']+'/data/datasets', "data dir")
tf.app.flags.DEFINE_string("dt_dir", '', "data dt partition")
tf.app.flags.DEFINE_string("model_dir", '', "model dir, automatica added by sm")
tf.app.flags.DEFINE_string("ckpt_dir", '', "check point dir, mannal added by user; for local mode, it is optmlmodel; for remote mode, it is opt ml checkpoints")
tf.app.flags.DEFINE_string("servable_model_dir", os.environ['SM_MODEL_DIR'], "export servable model for TensorFlow Serving")
### @guoren
tf.app.flags.DEFINE_string("task_type", 'train', "task type {train, infer, eval, export}")
tf.app.flags.DEFINE_boolean("clear_existing_model", False, "clear existing model or not")
tf.app.flags.DEFINE_integer("checkpoint_steps", 1, "Checkpoint steps save interval")
...
def main(_):
    ...
    print('checkpoint_step', FLAGS.checkpoint_steps)
    ...
    DeepFM = tf.estimator.Estimator(model_fn=model_fn, model_dir=FLAGS.ckpt_dir, params=model_params, config=config)
